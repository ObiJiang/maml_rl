...
# horizon of 100
initial_params_file1 = 'data/local/vpg-maml-point100midpoint/trpomaml1_fbs20_mbs40_flr_0.5metalr_0.01_step11/params.pkl'
...
initial_params_file5 = 'data/local/trpo-maml-point100/oracleenv2/params.pkl'
...
initial_params_files = [initial_params_file1, initial_params_file2, initial_params_file3, initial_params_file4, initial_params_file5, None]
step_sizes = [0.5/3, 0.5/3, 0.5/3, 0.5/3, 0.01, 0.5/3]
gen_name = 'icml_point_results_'
names = ['maml', 'heun', 'itb', 'ralston', 'oracle', 'random']
...
for step_i, initial_params_file in zip(range(len(step_sizes)), initial_params_files):
    avg_returns = []
    folder_exp_name = exp_names[exp_ind]
    exp_ind += 1
    for goal in goals:
        goal = list(goal)
        ...
        algo = VPG(
            ...
            max_path_length=100,
            n_itr=n_itr,
            folder_name = folder_exp_name,
            # scope = folder_exp_name,
        ...
        run_experiment_lite(
            ...
            exp_name=folder_exp_name,
            # plot=True,
        )
        # import pdb; pdb.set_trace()
        # get return from the experiment
        with open('data/local/trpopoint2d-test/' + folder_exp_name + '/progress.csv', 'r') as f:
